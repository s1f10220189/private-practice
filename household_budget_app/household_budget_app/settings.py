"""
Django settings for household_budget_app project.
...
SECRET_KEY = 'django-insecure-1e(dbeijg&tb8n1$)ncyia4#nlz3fd*+@^*-x4bkq*%=ev@_z%'
...
ROOT_URLCONF = 'household_budget_app.urls'
